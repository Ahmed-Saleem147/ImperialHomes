      ...
      <div className="p-8">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm mb-6 max-w-lg" style={{ border: "1px solid #F0EDE8" }}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm" style={{ color: "#6B7280" }}>{myShift.start_time} &ndash; {myShift.end_time}</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden" style={{ border: "1px solid #F0EDE8" }}>
          <div className="px-6 py-4" style={{ borderBottom: "1px solid #F0EDE8" }}>
            <h2 className="text-sm font-semibold" style={{ color: "#1A2744" }}>This Week &mdash; 30 Jun to 6 Jul 2026</h2>
          </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  {d.status === null && <p className="text-xs" style={{ color: "#D1CFC8" }}>&mdash;</p>}
                </div>
              );
            })}
          </div>

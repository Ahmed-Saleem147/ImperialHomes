...
export default function ManagementNotificationsPage() {
  const [items, setItems] = useState<Notification[]>(
    initial.filter((n) => n.for === "management" || n.for === "both")
  );
      ...
      <div className="p-4 lg:p-8">
        <div className="mb-6 flex items-center justify-between">
          ...
          {unread > 0 && (
            <button
              onClick={markAll}
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-semibold transition-opacity hover:opacity-80"
